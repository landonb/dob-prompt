...
docs:
	/bin/rm -f docs/dob_prompt.rst
	/bin/rm -f docs/modules.rst
	sphinx-apidoc -o docs/ dob_prompt
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
	$(PYBROWSER) docs/_build/html/index.html

isort:
	isort --recursive setup.py dob_prompt/ tests/
...
ifndef CLOC
	...
	@cloc --exclude-dir=.git,_build,dob_prompt.egg-info,.pytest_cache .
